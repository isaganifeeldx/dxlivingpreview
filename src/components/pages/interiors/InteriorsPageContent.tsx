...
interface InteriorsPageContentProps {
  content: InteriorsPageContentData
  moduleCards: ModulesPageModuleCard[]
}

const InteriorsPageContent: React.FC<InteriorsPageContentProps> = ({
  content,
  moduleCards,
}) => {
    ...
    <div className="min-h-screen page-content">
      ...
      <section className="mx-auto px-4 py-16 lg:h-screen h-[calc(65vh)] bg-cover bg-center bg-no-repeat relative flex items-center justify-center overflow-hidden banner-section">
        ...
        >
          <VimeoEmbed
            ...
            title="Luxury Interior Design | DX Interior"
      ...
      >
        <div className="max-w-[1200px] mx-auto text-center">
          <p
            className="mb-[100px] md:mb-[150px] lg:mb-[200px] black font-semibold leading-[38px]"
            data-animation="fade"
            data-delay="0.0"
            data-duration="0.5"
            tabIndex={1}
        ...
        <div className="max-w-[1200px] mx-auto text-center">
          <h2
            ...
            tabIndex={1}
          >
            {content.introduction.introVideo.heading}
          </h2>
          <p className="black" data-animation="fade" data-delay="0.5" data-duration="0.5" tabIndex={1}>
            {content.introduction.introVideo.content}
          </p>
        </div>
      </section>
      ...
      >
        <div
          className="mx-auto text-center rounded-[20px] overflow-hidden xl:h-[calc(100vh-80px)]"
          data-animation="fade"
          data-delay="0.5"
          data-duration="0.5"
        >
      ...
      <section
        className="scroll-trigger py-[100px] md:py-[200px] px-8 white-bg-section scroll-m-[-100px]"
        id="section-2"
      >
        <div className="max-w-[1200px] mx-auto text-center">
          <h2
        ...
        <div className="max-w-[1200px] mx-auto" data-animation="fade" data-delay="0.5" data-duration="0.5">
          ...
          <div className="grid sm:grid-cols-5 gap-4 divider-l">
            <p className="sm:col-span-5 text-center">{content.designYourSpace.lastContent}</p>
          </div>
        </div>
        <AnimatedButton
          onClick={() => handleNavigation(content.designYourSpace.buttonLink)}
          className="mt-[50px] md:mt-[100px] text-sm m-auto z-50 uppercase relative white-bg"
        >
          {content.designYourSpace.button}
        </AnimatedButton>
        <p
          ...
          data-delay="0.5"
          data-duration="0.5"
          dangerouslySetInnerHTML={html(content.designYourSpace.note)}
        />
      </section>

      <section
        className="scroll-trigger pb-[0px] md:pb-[50px] xl:pb-[50px] px-8 white-bg-section scroll-m-[100px]"
        id="section-5"
      >
        <div className="max-w-[1200px] mx-auto text-center">
          <h2
      ...
      <section
        className="md:px-16 px-8 pt-[100px] pb-[50px] md:pt-[200px] md:pb-[200px] bg-white white-bg-section scroll-m-[80px]"
        id="section-6"
      >
...
export default InteriorsPageContent
