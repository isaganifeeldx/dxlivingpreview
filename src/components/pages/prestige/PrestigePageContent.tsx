...
import type { PrestigePageContentData } from '@/lib/prestige/types'
import {
...
interface PrestigePageContentProps {
  content: PrestigePageContentData
  moduleCards: ModulesPageModuleCard[]
}

const PrestigePageContent: React.FC<PrestigePageContentProps> = ({
  content,
  moduleCards,
}) => {
  ...
  return (
    <div className="min-h-screen page-content">
      ...
      <section className="mx-auto px-4 py-16 lg:h-screen h-[calc(65vh)] bg-cover bg-center bg-no-repeat relative flex items-center justify-center overflow-hidden banner-section">
        ...
        >
          <VimeoEmbed
            ...
            title="Exclusive Home Previews | DX Prestige"
      ...
      <section
        className="scroll-trigger pt-[100px] md:pt-[150px] xl:pt-[200px] pb-[100px] px-8 white-bg-section"
        id="intro"
      >
        ...
        <div className="max-w-[1200px] mx-auto text-center">
          <h2
            className="heading-small mb-8 black overflow-hidden text-center opacity-0 max-w-[800px] mx-auto"
      ...
      >
        <div
          className="mx-auto text-center rounded-[10px] overflow-hidden xl:h-[calc(100vh-80px)]"
          data-animation="fade"
          data-delay="0.5"
          data-duration="0.5"
        >
      ...
      <section
        className="scroll-trigger py-[100px] md:py-[200px] px-8 white-bg-section scroll-m-[-80px]"
        id="section-2"
      >
      ...
      <section
        className="scroll-trigger py-0 md:pb-[50px] xl:pb-[50px] px-8 white-bg-section scroll-m-[100px]"
        id="section-5"
      >
        <div className="max-w-[1200px] mx-auto text-center">
          <h2
      ...
      <section
        className="md:px-16 px-8 pt-[100px] pb-[100px] md:pt-[150px] md:pb-[200px] bg-white white-bg-section scroll-m-[80px]"
        id="section-6"
      >
...
export default PrestigePageContent
